...
<div class="container mt-3 mb-3">
          <div class="row mb-3" >
            <div class="col">
              <div class="card">
              <img class="card-img-top"  src="../img/0001.jpg">
              <div class="card-body">
                <h4 class="card-title">Anime #1</h4>
                <p class="card-text">Anime #1...</p>
            ...
            <div class="col">
              <div class="card">
              <img class="card-img-top"  src="../img/0002.jpg">
              <div class="card-body">
                <h4 class="card-title">Anime #2</h4>
                <p class="card-text">Anime #2..</p>                  
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
              </div>
            </div>
            </div>
            <div class="col">
              <div class="card">
              <img class="card-img-top"  src="../img/0003.jpg">
              <div class="card-body">
                <h4 class="card-title">Anime #3</h4>
                <p class="card-text">Anime #3...</p>
                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
              </div>
            </div>
            </div>
